...
class PetitionsControllerTest < ActionController::TestCase
  ...
  test "should create petition" do
    assert_difference('Petition.count') do
      post :create, petition: { description: @petition.description, name: @petition.name, pdf_link: @petition.pdf_link }
    end
  ...
  test "should update petition" do
    put :update, id: @petition, petition: { description: @petition.description, name: @petition.name, pdf_link: @petition.pdf_link }
    assert_redirected_to petition_path(assigns(:petition))
  end
